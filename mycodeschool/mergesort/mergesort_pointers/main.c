...
// merge
void merge(int *sorted, int *left, int left_len, int *right, int right_len)
{
    int i=0, j=0, k=0;  // i - left index, j= right index, k - sorted index
